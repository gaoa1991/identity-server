...
namespace MechanicsBank.IdentityServer.Data
{
    public static class QueryableExtensions
    {
        ...
        public static IQueryable<T> PageBy<T, TKey>(this IQueryable<T> query, Expression<Func<T, TKey>> orderBy, int page, int pageSize, bool orderByAscending = true)
        {
